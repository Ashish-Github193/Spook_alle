...
from pygame.constants import K_RETURN, MOUSEBUTTONDOWN, MOUSEBUTTONUP
...
pygame.mixer.Channel(1).play(pygame.mixer.Sound(random.choice(wolf)), 0, 0, 1000)   #playing wolf howling randomly
...
while 1:
    ...
    while home_page_time:
        ...
        new_final = font_welcome.render("Score: " + str( get_leader_board_data() [str(get_save_data()[3])][0] + get_leader_board_data()[str(get_save_data()[3])][1]), True, "Yellow")
        ...
        for event in pygame.event.get():
            ...
            elif (x >= 64 and x <= 284) and (y >= 308 and y <= 345):  #continue game selection
            ...
            elif (x >= 65 and x <= 266) and (y >= 384 and y <= 421):   #settings selection
                ...
                if event.type == MOUSEBUTTONDOWN:
                    while settings_in:
                        ...
                        for event in pygame.event.get():
                            if event.type == pygame.QUIT:
                            ...
                            elif (x>= 222 and x<=448) and (y>=142 and y<187) and event.type == MOUSEBUTTONDOWN and settings_click_time[0]:
                                ...
                                if not volume:
                                    ...
                                    volume_font = font_internal.render("ON", True, "Yellow")
                                    ...
                                    pygame.mixer.Channel(8).set_volume(0.1*volume)
                                    pygame.mixer.Channel(9).set_volume(1*volume)
                                    volume_font = font_internal.render("OFF", True, "Yellow")
                            
                            elif (x>=228 and x<=507) and (y>=261 and y<=305) and event.type == MOUSEBUTTONDOWN and settings_click_time[1]:
                            ...
                            elif (x>=1237 and x<=1255) and (y>=23 and y<= 44) and event.type == MOUSEBUTTONDOWN:
                                settings_in = False
                ...
                if event.type == MOUSEBUTTONDOWN:
                    ...
                    while not click_home_screen[3]:
                        ...
                        for event in pygame.event.get():
                            ...
                            elif event.type == pygame.MOUSEBUTTONDOWN and(x>=1249 and x<=1267) and (y>=9 and y<=30):
                ...
                if event.type == MOUSEBUTTONDOWN:
                    ...
                    while not click_home_screen[4]:
                        ...
                        for event in pygame.event.get():
                            ...
                            elif event.type == pygame.MOUSEBUTTONDOWN and(x>=1239 and x<=1257) and (y>=15 and y<=36):
                                click_home_screen = [1,1,1,1,1,1]
